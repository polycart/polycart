...
class LeadScreen(DefaultScreen):
    ...
    def ad_init(self):
        self.scroll.add_ad_lead('http://39.96.48.80/ads/kangshifuwater.jpg', '康师傅矿泉水', (30, 20))
        self.scroll.add_ad_lead('http://39.96.48.80/ads/kangshifuyinliao.jpg', '康师傅茉莉花茶', (40, 30))
        self.scroll.add_ad_lead('http://39.96.48.80/ads/wahaha.jpg', '娃哈哈AD钙奶', (30, 20))
        self.scroll.add_ad_lead('http://39.96.48.80/ads/cola.jpg', '可口可乐', (30, 20))
...
class AdScreen(DefaultScreen):
    ...
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.scroll.add_ad('http://39.96.48.80/ads/kangshifuwater.jpg', '康师傅矿泉水', (30, 20))
        self.scroll.add_ad('http://39.96.48.80/ads/kangshifuyinliao.jpg', '康师傅茉莉花茶', (40, 30))
        self.scroll.add_ad('http://39.96.48.80/ads/wahaha.jpg', '娃哈哈AD钙奶', (30, 20))
        self.scroll.add_ad('http://39.96.48.80/ads/cola.jpg', '可口可乐', (30, 20))
